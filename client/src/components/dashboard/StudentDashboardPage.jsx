  ...
  return (
    <div className="pt-20 py-6 container-custom bg-background text-foreground">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="glass-card rounded-xl p-6 animate-fade-in animate-delay-100 cursor-pointer" onClick={() => navigate("/profile?section=projects")}>
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-medium text-lg">Projects & Internships</h3>
            <Code className="h-6 w-6 text-primary" />
          </div>
          <p className="text-3xl font-bold">{userProjects.length + userInternships.length}</p>
          <p className="text-sm text-green-600 dark:text-green-400 flex items-center mt-1">
            {userInternships.filter(i => i.current).length > 0 ? "1 active internship" : "Build your portfolio"}
          </p>
        </div>

        <div className="glass-card rounded-xl p-6 animate-fade-in animate-delay-200 cursor-pointer" onClick={goToAlumniDirectory}>
          <div className="flex items-center justify-between mb-4">
      ...
      {/* Main dashboard content - 3-column grid layout */}
